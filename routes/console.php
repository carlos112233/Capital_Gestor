...
Schedule::command('whatsapp:recordatorios')->monthlyOn(15, '18:00')->timezone('America/Mexico_City')->withoutOverlapping();
Schedule::command('whatsapp:recordatorios')->lastDayOfMonth('18:00')->timezone('America/Mexico_City')->withoutOverlapping();
