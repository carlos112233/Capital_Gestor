                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($entradas as $entrada)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-500">{{ \Carbon\Carbon::parse($entrada->fecha_generado)->format('Y-m-d H:i:s') }}</td>
                                    <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-500">
                                        ...
                                        {{-- Botón Eliminar --}}
                                        <form class="inline-block ml-4" action="{{ route('admin.entradas.destroy', $entrada) }}" method="POST"
