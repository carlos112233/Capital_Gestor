                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4 flex gap-2">
                        <div class="relative w-full group">
                            <input type="text" id="search" class="block rounded-t-lg px-3 pb-2 pt-6 w-full text-sm text-slate-800 bg-slate-100 border-0 border-b-2 border-slate-300 appearance-none focus:outline-none focus:ring-0 focus:border-indigo-600 peer pr-10 transition-colors focus:bg-slate-200/50" placeholder=" " autocomplete="off" />
                        ...
                        <button onclick="exportarExcel()" title="Exportar a Excel"
                            class="inline-flex items-center justify-center p-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white shadow-md shadow-emerald-500/30 focus:outline-none cursor-pointer">
                        ...
                        <button id="btn-envio-masivo" title="WhatsApp Masivo"
                            class="inline-flex items-center justify-center p-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white shadow-md shadow-green-500/30 focus:outline-none cursor-pointer">
                                                    ...
                                                    @if($r->image)
                                                        <div x-data="{ openTablePhoto: false }">
                                                            <button @click="openTablePhoto = true" class="focus:outline-none cursor-pointer transform hover:scale-110 transition-transform">
                                                                <img src="data:{{ $r->image_tipo }};base64,{{ $r->image }}" class="w-8 h-8 rounded-full object-cover border border-slate-200 shadow-sm" alt="Foto">
                                                            </button>
                                                            ...
                                                            <div x-show="openTablePhoto" style="display: none;" x-transition class="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/80 backdrop-blur-sm p-4">
                                                                <div @click.away="openTablePhoto = false" class="relative w-full max-w-3xl flex justify-center items-center">
                                                                    ...
                                                                    <img src="data:{{ $r->image_tipo }};base64,{{ $r->image }}" class="max-w-full max-h-[85vh] rounded-2xl shadow-2xl object-contain border border-white/10">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
