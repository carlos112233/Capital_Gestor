                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4 flex gap-2">
                        <div class="relative w-full">
                            ...
                            <input type="text" id="search" placeholder="Buscar cliente por nombre o correo..."
                                class="w-full pl-11 pr-4 py-2.5 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 text-slate-800 text-sm font-medium transition-all outline-none bg-slate-50/50 hover:bg-white focus:bg-white shadow-xs">
                        </div>
