            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('catalogo.index')" :active="request()->routeIs('catalogo.index')">
                     ...
                     <x-nav-link :href="route('ventas.index')" :active="request()->routeIs('admin.ventas.*')">
                            {{ __('Ventas') }}
                     </x-nav-link>
                    
                     @if(Auth::user()->hasRole('admin'))
                        <x-nav-link :href="route('admin.articulos.index')" :active="request()->routeIs('admin.articulos.*')">
                            {{ __('Artículos') }}
                        </x-nav-link>
